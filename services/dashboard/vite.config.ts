...
export default defineConfig({
  optimizeDeps: {
    include: [
      ...
      '@mui/icons-material',
      // See https://stackoverflow.com/questions/72097831/popper-styled-default-is-not-a-function-mui-5-6-0-material-ui
  ...
  build: {
    sourcemap: process.env.SENTRY_RELEASE !== undefined, // only enable sourcemaps for Sentry releases
  },
})
