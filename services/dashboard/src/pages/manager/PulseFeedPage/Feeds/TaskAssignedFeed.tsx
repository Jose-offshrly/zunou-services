...
import { TaskPriority, TaskStatus, User } from '@zunou-graphql/core/graphql'
...
interface TaskAssignedFeedProps {
  dateString: string
  description: string
    ...
    <FeedCard direction="row" gap={2} onClick={onClickHandler}>
      ...
      <Stack gap={2}>
        <Stack>
          ...
          {/* Commented for now since BE is returning the entire sentence */}
          <Typography color="text.secondary" variant="body2">
            Assigned a new task to you in{' '}
            <Typography
              color="text.primary"
              component="span"
              fontWeight="bold"
...
export default TaskAssignedFeed
