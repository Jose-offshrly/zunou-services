...
return [
    ...
    */
    ...
    | Auto-enabled when using Redis or Memcached, which support cache tags.
    | File and DynamoDB drivers don't support tags and will rely on TTL expiration.
    |
    */
    'cache_directive_tags' => in_array(env('CACHE_DRIVER', 'file'), ['redis', 'memcached']),
    ...
    */
    ...
    'security' => [
        ...
        'disable_introspection' => (bool) env(
