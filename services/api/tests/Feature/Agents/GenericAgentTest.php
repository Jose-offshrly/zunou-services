...
{
    public function test_generic_agent_can_summarize_zunou_for_media_proposal_document()
    {
    ...
    public function test_generic_agent_can_extract_feature_ideas_from_multiple_notes()
    {
        $userId  = '9babc0b6-5406-4474-ac89-d3c613112b35';
        $pulseId = '4c689cf4-ab49-40ba-aabb-d35f9bddc75b';
        $uuid    = (string) Str::uuid();
    ...
    public function test_generic_agent_can_summarize_latest_meeting()
    {
        $userId  = '9babc0b6-5406-4474-ac89-d3c613112b35';
        $pulseId = '4c689cf4-ab49-40ba-aabb-d35f9bddc75b';
        $uuid    = (string) Str::uuid();
    ...
    public function test_generic_agent_can_summarize_catch_jobs_meeting()
    {
        $userId  = '9babc0b6-5406-4474-ac89-d3c613112b35';
        $pulseId = '4c689cf4-ab49-40ba-aabb-d35f9bddc75b';
        $uuid    = (string) Str::uuid();
    ...
    public function test_generic_agent_can_summarize_catch_jobs_meeting2()
    {
        $userId  = '9babc0b6-5406-4474-ac89-d3c613112b35';
        $pulseId = '4c689cf4-ab49-40ba-aabb-d35f9bddc75b';
        $uuid    = (string) Str::uuid();
