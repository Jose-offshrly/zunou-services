...
final readonly class GenerateUploadCredentialsMutation
{
    /** @param  array{}  $args */
    public function __invoke(null $_, array $args)
    {
        ...
        $key = 'organizations/' .
            $this->uuidToFolderPath($args['organizationId']) .
            '/' .
            str_replace('_', '-', strtolower($args['uploadType'])) .
            's/' .
            $this->uuidToFolderPath(Str::uuid()->toString()) .
            '.' .
            strtolower($args['fileType']);
