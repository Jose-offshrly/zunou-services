...
final class UpdateInsightStatusMutation
{
    /**
     * Unified status management for live insights with intelligent transitions.
     * Status flow: pending → delivered → seen → closed
     */
