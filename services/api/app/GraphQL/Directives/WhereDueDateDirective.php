...
final class WhereDueDateDirective extends BaseDirective implements
...
directive @whereDueDate on ARGUMENT_DEFINITION
GRAPHQL;
    }
    ...
    public function handleBuilder(
        ...
        return $builder->when($date, function ($q) use ($date) {
            $q->whereDate(
                'due_date',
                '=',
