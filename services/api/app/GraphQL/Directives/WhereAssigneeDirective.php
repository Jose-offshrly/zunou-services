...
final class WhereAssigneeDirective extends BaseDirective implements
...
directive @whereAssignee on ARGUMENT_DEFINITION
GRAPHQL;
    }
    ...
    public function handleBuilder(
        ...
        return $builder->when($assigneeId, function ($q) use ($assigneeId) {
