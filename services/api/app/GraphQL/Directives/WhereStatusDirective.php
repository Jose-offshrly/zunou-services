...
final class WhereStatusDirective extends BaseDirective implements
...
directive @whereStatus on ARGUMENT_DEFINITION
GRAPHQL;
    }
    ...
    public function handleBuilder(
        ...
        return $builder->when($status, function ($q) use ($status) {
