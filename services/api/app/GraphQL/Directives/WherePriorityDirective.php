...
final class WherePriorityDirective extends BaseDirective implements
...
directive @wherePriority on ARGUMENT_DEFINITION
GRAPHQL;
    }
    ...
    public function handleBuilder(
        ...
        return $builder->when($priority, function ($q) use ($priority) {
