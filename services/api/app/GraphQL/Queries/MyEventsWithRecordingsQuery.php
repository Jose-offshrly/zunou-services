...
readonly class MyEventsWithRecordingsQuery
{
    /**
     * Get all events with meeting recordings that the current user can access.
     * Returns events where user is a member of the pulse and event has a dataSource.
     *
    ...
    public function __invoke($rootValue, array $args): array
    {
        ...
        $query = Event::query()
            ...
            // Must have a meeting session with a data source (recording)
            ->whereHas('meetingSession', function ($q) {
                $q->whereHas('dataSource');
            })
