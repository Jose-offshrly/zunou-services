 ...
 *
 * The dashboard frontend uses useHubChat (hooks/useHubChat.ts) to subscribe to Hub events (.team-deleted),
 ...
 */
class TeamMessageDeleted implements ShouldBroadcast
{
    use Dispatchable;
