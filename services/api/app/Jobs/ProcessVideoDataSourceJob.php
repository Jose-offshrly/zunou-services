...
class ProcessVideoDataSourceJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        Log::info(
            'ProcessVideoDataSourceJob: processing file with data source ID ' .
                $this->dataSourceId,
        );
        ...
        try {
            ...
            Log::info(
                'ProcessVideoDataSourceJob: File processed successfully.',
            );
            ...
            Log::error('ProcessVideoDataSourceJob: Error ' . $e->getMessage());
