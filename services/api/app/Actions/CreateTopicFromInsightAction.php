    ...
    public static function execute(
        ...
        $welcomeMessage = json_encode([
            'message' =>
                ...
                '! The ' .
                $topic->name .
                ' seems like a key project. Would you like me to explain what progress has been made and how it impacts the app’s event capabilities?',
            'ui' => [
                'type' => 'options',
                'options' => [
                    [
                    ...
                    [
                        ...
                        'suggested_reply' =>
                            'Give recommendations for this topic: ' .
                            $topic->name,
                        'option_context' => [
