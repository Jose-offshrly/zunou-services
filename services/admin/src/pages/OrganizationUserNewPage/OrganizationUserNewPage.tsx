...
const OrganizationUserNewPage = () => {
  ...
  useTrackQuery(
    `${Routes.OrganizationUserNew}:organization`,
  ...
  useTrackQuery(`${Routes.OrganizationUserNew}:inviteUser`, isPendingCreate)
...
export default withAuthenticationRequired(OrganizationUserNewPage, {
